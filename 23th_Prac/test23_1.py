...
plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="cividis")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="Blues")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="viridis")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="inferno")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="magma")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="Spectral")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="plasma")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="spring")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="pink")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="winter")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="autumn")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="summer")
# plt.scatter(x+4.5, y+1.5, 200, "C6", alpha=0.5, cmap="Set1")
